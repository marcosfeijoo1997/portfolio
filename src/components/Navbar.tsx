...
const clickedStyle = (item: string) => {
  ...
  return (
    <header className={`fixed z-[100]  text-custom  flex w-full mx-auto ${textWhite} ${bgDark}`}>
      <ul className="flex">
      ...
      <Link href="/contacto"> <li className={`px-4 py-3 ${clickedStyle("contacto")} ${hover}`} onClick={()=>activeHover("contacto")}>Contacto</li></Link>
      </ul>
      <ul className={`flex w-full justify-end  mr-10 ${theme=="dark"?"fill-white":"fill-black"}`}>
        ...
        <li className='p-3 py-3 cursor-pointer'><svg width="20px" height="20px" viewBox="0 0 16 16"  ><path  d="M8 1C4.133 1 1 4.13 1 7.993c0 3.09 2.006 5.71 4.787 6.635.35.064.478-.152.478-.337 0-.166-.006-.606-.01-1.19-1.947.423-2.357-.937-2.357-.937-.319-.808-.778-1.023-.778-1.023-.635-.434.048-.425.048-.425.703.05 1.073.72 1.073.72.624 1.07 1.638.76 2.037.582.063-.452.244-.76.444-.935-1.554-.176-3.188-.776-3.188-3.456 0-.763.273-1.388.72-1.876-.072-.177-.312-.888.07-1.85 0 0 .586-.189 1.924.716A6.711 6.711 0 018 4.381c.595.003 1.194.08 1.753.236 1.336-.905 1.923-.717 1.923-.717.382.963.142 1.674.07 1.85.448.49.72 1.114.72 1.877 0 2.686-1.638 3.278-3.197 3.45.251.216.475.643.475 1.296 0 .934-.009 1.688-.009 1.918 0 .187.127.404.482.336A6.996 6.996 0 0015 7.993 6.997 6.997 0 008 1z" clipRule="evenodd"/></svg></li>
        <li className='p-3 py-3 cursor-pointer'><svg width="20px" height="20px" viewBox="0 0 24 24" role="img"  aria-labelledby="languageIconTitle" stroke={`${theme=="dark"?"white":"black"}`} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" > <title id="languageIconTitle">Language</title> <circle cx="12" cy="12" r="10"/> <path strokeLinecap="round" d="M12,22 C14.6666667,19.5757576 16,16.2424242 16,12 C16,7.75757576 14.6666667,4.42424242 12,2 C9.33333333,4.42424242 8,7.75757576 8,12 C8,16.2424242 9.33333333,19.5757576 12,22 Z"/> <path strokeLinecap="round" d="M2.5 9L21.5 9M2.5 15L21.5 15"/> </svg></li>
        <li className='p-3 py-3 cursor-pointer' onClick={()=>toggleTheme()}><svg  className="h-5 w-5" viewBox="0 0 20 20"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clipRule="evenodd"></path></svg></li>
      </ul>
    </header>
  );
};
