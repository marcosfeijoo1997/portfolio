...
const Navbar = () => {
  ...
  return (
    <header className="fixed flex w-full mx-auto py-4 bg-dark bg-opacity-70 text-white text-custom">
      ...
      <ul className="flex w-full justify-end gap-10 mr-10 fill-white">
        <li>
